...
namespace SimhereApp.iOS.Renderers
{
    public class TabbedPageRenderer : TabbedRenderer
    {
        ...
        public override void ViewWillAppear(bool animated)
        {
           ...
           Portable.App.TabBarHeight = (int)TabBar.Frame.Height;
        ...
        void AddFonts()
        {
            ...
            UITabBarItem.Appearance.SetTitleTextAttributes(new UITextAttributes
            {
                TextColor = Color.FromHex("#4267B2").ToUIColor(),
                Font = UIFont.SystemFontOfSize(12)
        ...
        private void UpdateTabBarItem(UITabBarItem item, string icon)
        {
            ...
            item.SetTitleTextAttributes(new UITextAttributes() { TextColor = Color.FromHex("#757575").ToUIColor(), Font = UIFont.SystemFontOfSize(12) }, UIControlState.Normal);
            item.SetTitleTextAttributes(new UITextAttributes() { TextColor = Color.FromHex("#4267B2").ToUIColor(), Font = UIFont.SystemFontOfSize(12) }, UIControlState.Selected);
        ...
        void AddSelectedTabIndicator()
        {
            ...
            {
                // UITabBar.Appearance.SelectionIndicatorImage = GetImageWithColorPosition(Color.FromHex("#4267B2").ToUIColor(), new CGSize(UIScreen.MainScreen.Bounds.Width / base.ViewControllers.Length, tabbedController.TabBar.Bounds.Size.Height + 4), new CGSize(UIScreen.MainScreen.Bounds.Width / base.ViewControllers.Length, 4));
            }
