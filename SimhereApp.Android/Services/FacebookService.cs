...
namespace SimhereApp.Droid.Services
{
    public class FacebookService : Java.Lang.Object, IFacebookService, IFacebookCallback, GraphRequest.IGraphJSONObjectCallback
    {
        ...
        public void OnSuccess(Java.Lang.Object result)
        {
            ...
            if (n != null)
            {
                ...
                var bundle = new Android2.OS.Bundle();
                bundle.PutString("fields", "id,name,first_name, email, last_name, picture.width(500).height(500)");
        ...
        public void OnCompleted(JSONObject p0, GraphResponse p1)
        {
            ...
            _onLoginComplete?.Invoke(new FacebookUser(id, AccessToken.CurrentAccessToken.Token, first_name, last_name,fullname, email, pictureUrl), null);
        }
        #endregion
    }
}
